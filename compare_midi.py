...
note_name_maps = {
    ...
    'HARM1': {
        ...
        63: "D#3",
        62: "D3",
        61: "C##",  # Check this, C## is unusual, might be a typo and should be C#.
        60: "C3",
        59: "B2",
        58: "A#2",
        57: "A2",
    ...
    'PART REAL_KEYS_X': {
        ...
        9: "Range A2-C4",  # Note: Including this range indicator as it is not a dash line
        5: "Range F2-A3",  # Same as above
        0: "Range C2-E3"   # Including range without explicit dash
    },
    'PART KEYS': {
        127: "LANE MARKER",
        124: "BRE",
...
IGNORED_TRACKS = {'PART POOP'}

# Define the tracks to compare
TRACKS_TO_COMPARE = {
    'PART BASS', 'PART GUITAR', 'MARKUP', 'BEAT', 'EVENTS', "VENUE", 'HARM1', 'HARM2', 'HARM3', "PART VOCALS", 'PART VOCALS', 'PART REAL_GUITAR', 'PART KEYS', 'PART REAL_KEYS_X', 
    'PART REAL_KEYS_H', 'PART REAL_KEYS_M', 'PART REAL_KEYS_E', 'PART KEYS_ANIM_RH', 'PART KEYS_ANIM_LH', "PLASTIC GUITAR", "PLASTIC DRUMS", "PLASTIC BASS"
}
