...
class FestRPCCog(commands.Cog):
    ...
    async def about(self, interaction: discord.Interaction):
        ...
        embed.add_field(name='What is Festival RPC?', value="[Festival RPC](https://github.com/mmccall0813/FestivalRPC/) is a program that allows you to display the songs you play in Fortnite Festival on your Discord profile as Rich Presence (or Activity).\nFestival RPC can also scrobble the songs you play to [last.fm](https://www.last.fm/), provided you have an API key.", inline=False)
