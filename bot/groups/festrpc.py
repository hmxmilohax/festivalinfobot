...
class FestRPCCog(commands.Cog):
    ...
    async def about(self, interaction: discord.Interaction):
        ...
        embed.add_field(name='What is Festival RPC?', value="[Festival RPC](https://github.com/mmccall0813/BetterFestivalRPC/) is a program that allows you to display the songs you play in Fortnite Festival on your Discord profile as Rich Presence (or Activity).\nFestival RPC can also scrobble the songs you play to [last.fm](https://www.last.fm/), provided you have an API key.", inline=False)
        embed.add_field(name='How do I set-up Festival RPC?', value='To set-up Festival RPC, first [download it here](https://github.com/mmccall0813/BetterFestivalRPC/archive/refs/heads/main.zip)\nNow, download [node.js](https://nodejs.org/en) and install it. The process wont take long.\nAfterwards, extract `festivalrpc-main.zip` and run `install_deps.bat`.\nNow, run `start.bat` and you\'re ready to share your activity!', inline=False)
