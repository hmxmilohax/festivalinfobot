...
class LyricsHandler():
    ...
    async def handle_interaction(self, interaction: discord.Interaction, query: str, pt: Literal['No', 'Yes', 'Yes (Include Overdrive)'], style: Literal['Legacy', 'Stable'], should_be_ephemeral: bool = False):
        ...
        try:
            if pt == 'No':
                fname = await self.load_lyrics(track, legacy=style == 'Legacy')
    ...
    async def load_lyrics(self, track, plain_text: bool = False, legacy: bool = False) -> str:
        midi = track['track']['mu']
    ...
    def draw_lyrics_legacy(self, sentences, 
        album_art_path, 
        font_path, 
        font_size=40, 
        separation=50, 
